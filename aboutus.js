document.addEventListener("DOMContentLoaded", function () {
  ...
  /**
   * ------------------------------------------------------------------
   * This function finds elements and adds the '.is-visible' class
   * to trigger the animations you added to your CSS.
   * ------------------------------------------------------------------
   */
  const observeElements = () => {
    
    // 1. Observer for main sections (uses '.section-animate-init')
    ...
    // 2. Observer for staggered cards (uses '.card-animate-init')
